...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-path", type=str, default=default_config_path_prob_1)
    parser.add_argument("--config-path", type=str, default=default_config_path_prob_2)
